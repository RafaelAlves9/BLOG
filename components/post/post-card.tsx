   ...
   if (variant === "featured") {
      return (
         <div className="group relative overflow-hidden rounded-lg border border-gray-800 bg-[#1a2236] transition-all hover:border-gray-700">
            ...
            <Link
               href={`/blog/${post.slug.replaceAll(" ", "-")}`}
      ...
      return (
         <div className="group flex gap-4 items-start">
            <div className="relative h-16 w-16 flex-shrink-0 overflow-hidden rounded-md">
               <Image
                  src={
                     post.featuredImage || `/placeholder.svg?height=64&width=64`
                  }
                  alt={post.title}
                  fill
                  className="object-cover"
      ...
      return (
         <div className="group overflow-hidden rounded-lg border border-gray-800 bg-[#1a2236] transition-all hover:border-gray-700">
            ...
            >
               ...
               <div className="p-4 space-y-2">
                  <div className="text-xs text-cyan-400 uppercase mb-1">
   ...
   return (
      <div className="group overflow-hidden rounded-lg border border-gray-800 bg-[#1a2236] transition-all hover:border-gray-700">
         <div className="relative aspect-video w-full overflow-hidden">
            <Image
               src={
                  post.featuredImage || `/placeholder.svg?height=300&width=500`
               }
               alt={post.title}
               fill
               className="object-cover transition-transform group-hover:scale-105"
         ...
         <div className="p-4 space-y-2">
            <div className="flex flex-wrap gap-2">
               {post.categories.slice(0, 2).map((category) => (
                  <Link
                     key={category}
                     href={`/blog?category=${category.replaceAll(" ", "-")}`}
                  >
                     <Badge
                        variant="secondary"
                        className="bg-[#1e293b] hover:bg-[#1e293b]/80 text-cyan-400"
                     >
